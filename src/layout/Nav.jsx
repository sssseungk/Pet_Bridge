...
function Nav() {
  return (
    <>
      <nav className="w-full max-w-4xl h-[52px] bg-pet-bg px-[28px] py-[16px] bottom-0 fixed rounded-b-xl left-0 right-0 m-auto border shadow-[0_-8px_20px_0_rgba(0,0,0,0.1)]">
