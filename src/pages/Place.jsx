    ...
    <>
      <article className="max-w-4xl mx-auto my-0 relative bg-pet-bg">
        ...
        <section className=" relative top-[-3.5rem] mb-[-3.5rem] w-[92%] mx-auto my-0">
          ...
          <Link
            to={`/map`}
            className="bg-primary text-2xl md:text-4xl lg:text-5xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex justify-between items-center pl-[6%] pr-[3%] pt-[4%] pb-[3%] rounded-[20px]"
          >
            <p className="font-extrabold leading-[1.8rem] md:leading-[2.8rem] w-[55%] transition-[0.3s]">
              <span className="text-xs md:text-lg lg:text-2xl block font-bold leading-[normal] transition-[0.3s] mb-[0.3rem]">
                가까운 곳부터 천천히
              </span>
              내 주변
              <br /> 보호소 찾기
        ...
        <section className="w-[92%] mx-auto my-0">
          ...
          <div className="bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[15px] p-[4%]">
            ...
            <dl>
              <dt className="text-base font-bold mt-[5%] mb-[2%] mx-0">
                고양시 동물보호센터
              </dt>
            ...
            <div className="flex justify-between text-sm mt-[5%]">
              <a
                ...
                className="bg-primary rounded-[10px] w-[48%] flex justify-center items-center px-0 py-[3%] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]"
              >
                <img
                  className="inline-block w-[13%] mr-[5%]"
                  src={callIcon}
                  alt=""
                />
                전화하기
              ...
              <button
                onClick={openModal}
                className="bg-pet-green rounded-[10px] text-white w-[48%] flex justify-center items-center px-0 py-[3%] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]"
              >
                <img
                  className="inline-block w-[11%] mr-[5%]"
                  src={PlaceIcon}
                  alt=""
                />
                위치보기
        ...
        <section className="w-[92%] mx-auto my-0 pb-[25%]">
          <h2 className="font-bold mt-[14%] mb-[3%] mx-0 text-sm">
            보호소 사이트 방문하기
          </h2>
          <ul>
            {placeList ? (
                ...
                <li key={place.id}>
                  ...
                  >
                    ...
                    <dl className="pl-[2.5%] text-left">
                      <dt className="text-sm font-bold mb-[3%]">
                        {place.title}
                      </dt>
